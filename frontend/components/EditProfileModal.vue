  ...
  const updateProfile = async () => {
    console.log("Enviando datos al backendAA:", {
      userbio: bio.value, // Primero
      userid: props.userData.sub, // Segundo
      username: username.value // Tercero
    });
    console.log("Contenido de props.userData:", props.userData);
